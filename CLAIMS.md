...
| arm9 fan-out (0x1f0-0x27c, 14 funcs): scattered main-binary 0x02013f4c-0x02072fcc | tangosdev (Claude/Fable) | 2026-07-12 | in progress - Fable fan-out on the hard arm9 residue (no-good-sibling, sim 0.33-0.40). Disjoint from andrew (<=0x1ec) + Session2 (>=0x280). API 401, via row. |
